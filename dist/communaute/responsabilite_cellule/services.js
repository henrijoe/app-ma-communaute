...
const ajouterResponsabilite = (data) => {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const idMembre = yield functions_1.default.ajouterResponsabilite(Object.assign({}, data));
            const responsabilite = yield functions_1.default.recupResponsabiliteById(idMembre);
...
const supprimerResponsabilite = (idMembre) => {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const responsabilites = yield functions_1.default.recupResponsabilite();
            if (Array.isArray(responsabilites)) {
                ...
                if (index >= 0) {
                    ...
                    yield functions_1.default.supprimerResponsabilite(idMembre);
                    resolve(true);
                }
                else {
