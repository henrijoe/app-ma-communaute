import{a as R,g as _,aw as k,s as M,_ as o,ax as g,r as S,u as j,b as A,j as l,c as U,d as $,V as d}from"./index-B48XCzkR.js";import{a as E}from"./Stack-KFvpuAGE.js";function P(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function B(t){return parseFloat(t)}function I(t){return R("MuiSkeleton",t)}_("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const L=["animation","className","component","height","style","variant","width"];let r=t=>t,m,f,v,b;const X=t=>{const{classes:a,variant:e,animation:s,hasChildren:n,width:c,height:i}=t;return $({root:["root",e,s,n&&"withChildren",n&&!c&&"fitContent",n&&!i&&"heightAuto"]},I,a)},z=k(m||(m=r`
  0% {
    opacity: 1;
  }
